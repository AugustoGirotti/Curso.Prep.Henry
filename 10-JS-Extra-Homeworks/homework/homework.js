...
function asAmirror(str) {
  ...
  stringEspejo = stringSeparada.map(function(palabra){ 
...
function capicua(numero){
  ...
  numeroAlReves = numeroString.split('').reverse().join('')
  if (numeroAlReves === numeroString){
    return 'Es capicua'
  } else {
...
function sortArray(arr) {
  ...
  //Escribe tu código aquí
  function ordenarporlength(a, b) {
    return a.length - b.length;
  }
  var nuevoArray = arr.sort(ordenarporlength)
  return nuevoArray;
}
